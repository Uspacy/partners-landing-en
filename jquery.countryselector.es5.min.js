"use strict";(function(n){function o(n,t){return n?typeof n!="string"?[]:n.split(t):[]}var f = 0,
  i = 1,
  e = 2,
  t = 3,
  u = [
  ...
  r = {
    init: function (r) {
      return (
        ...
        this.each(function () {
          var h = n(this),
            p = r.value || h.val() || h.attr("value"),
            a = r.codeMode || h.data("code-mode") || "alpha3",
            w = r.showFlag === undefined ? h.data("show-flag") : r.showFlag,
            l = a == "alpha2" ? f : a == "numeric" ? e : i,
            v = r.valueSet || o(h.data("value-set"), " "),
            y =
              v.length == 0
                ? u
                : n.grep(u, function (n) {
                    return v.indexOf(n[l]) >= 0;
                  }),
            c,
            s;
          w
            ? (function () {
                var f = function (n) {
                    var i = s.scrollTop(),
                      t = n.position().top,
                      r = t + n.height();
                    (t < 0 || r > s.height()) && s.scrollTop(i + t);
                  },
                  r = function (n) {
                    var r = n.data("country"),
                      u;
                    c.find("span.cs-flag-selected")
                      .removeClass()
                      .addClass("cs-flag-selected cs-flag " + r[i]);
                    c.find("span.cs-name-selected").text(r[t]);
                    u = r[l];
                    h.val(u).change();
                    n.addClass("cs-selected")
                      .siblings()
                      .removeClass("cs-selected");
                    f(n);
                  },
                  u = function (n) {
                    var i = s.children("li.cs-selected"),
                      t = null;
                    i.length == 0
                      ? (t = s.children("li:first"))
                      : n == "up"
                      ? (t = i.prev())
                      : n == "down" && (t = i.next());
                    t.length > 0 && r(t);
                  ...
                  e = function (i) {
                    s.children("li").each(function () {
                      var u = n(this),
                        f = u.data("country"),
                        e = f[t];
                      if (e.indexOf(i) === 0) return r(u), !1;
                    });
                  },
                  o = function () {
                    var n = c.position(),
                      t = n.left,
                      i = n.top + c.outerHeight();
                    s.css({ left: t + "px", top: i + "px" }).show();
                  },
                  a = function (t) {
                    s.children("li").each(function () {
                      var i = n(this),
                ...
                h.hide().attr("autocomplete", "off");
                c = n(
                  '<div class="cs-selector" tabindex="0"><span class="cs-flag-selected cs-flag XXX"></span><span class="cs-name-selected"></span><span class="cs-arrow"></span></div>'
                ).insertAfter(h);
                s = n(
                  '<ul class="cs-list" style="display: none;"></ul>'
                ).insertAfter(c);
                c.on("focus click", o)
                  .blur(function () {
                  ...
                  .keydown(function (n) {
                    ...
                    t >= 65 &&
                      t <= 90 &&
                      (e(String.fromCharCode(t)), n.preventDefault());
                  });
                s.on("click", "li", function (t) {
                  r(n(t.target));
                  s.hide();
                });
                n.each(y, function (r, u) {
                  n(
                    '<li><span class="cs-flag ' +
                      u[i] +
                      '"></span>' +
                      u[t] +
                      "</li>"
  ...
  };n.fn.countrySelector=function(t){if(r[t])return r[t].apply(this,Array.prototype.slice.call(arguments,1));if(typeof t!="object"&&t)n.error("Method "+t+" does not exist on jQuery.countrySelector");else return r.init.apply(this,arguments)};n("select[data-role=country-selector]").countrySelector()})(jQuery);